...
export default function CreateTransactionsDialog({trigger, type}: Props) {
  ...
  const { mutate, isPending } = useMutation({
    ...
    onSuccess: () => {
        ...
        // after creating a tranaction, we need t o invalidate the overview query which will refetch data in the homepage
