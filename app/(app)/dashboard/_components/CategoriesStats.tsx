            ...
            <div className="flex items-center justify-between gap-2">
                {filteredData.length === 0 && (
                    <div className="flex h-60 w-full flex-col items-center justify-center">
                        ...
                        <p className='text-sm text-muted-foreground'>Try selecting a different perioed or try adding new {" "} {type === 'income' ? 'incomes' : 'expenses'}</p>
                    </div>
                )}
                            ...
                            {filteredData.map((item) => {
                                ...
                                return (
                                    <div className='flex flex-col gap-2' key={item.category}>
                                        ...
                                        <Progress 
                                        value={percentage} 
                                        indicator={type === "income" ? "bg-emrald-500" : "bg-red-500"}
                                        />
                                    </div>
                                )
                            })}
