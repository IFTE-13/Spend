                ...
                <SkeletonWrapper isLoading={historyDataQuery.isFetching}>
                    {
                        ...
                        <ResponsiveContainer width={"100%"} height={300}>
                            <BarChart height={300} data={historyDataQuery.data} barCategoryGap={5}>
                                <defs>
                                    <linearGradient id="incomeBar" x1={0} x2={0} y1={0} y2={0}>
                                        <stop offset={"0"} stopColor="#10b981" stopOpacity={1} />
                                        <stop offset={"1"} stopColor="#10b981" stopOpacity={0} />
                                    </linearGradient>
                                    <linearGradient id="expenseBar" x1={0} x2={0} y1={0} y2={0}>
                    ...
                    {
                        !dataAvailable && <div className="flex h-[300px] justify-center items-center flex-col bg-background">No data for the selected Period
...
function CustomeTooltip({active, payload}: any){
